  ...
  <hr>
        ...
        <div class="row text-center">
           <h2>To enable Mobile apps addons for your business please contact at : </h2><span class="contact-addons">danish.ahmed@diginctechnologies.com</span> , Skype : <span class="contact-addons">danish.ahmed</span>
        </div>
            </div>
        </div>
    </div>
