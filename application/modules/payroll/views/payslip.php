        ...
        <div class="panel panel-bd">
            ...
            <div id="printArea">
                <div class="panel-body" id="payslip">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <address>
                                            <strong><?php echo (!empty($setting->title) ? $setting->title : 'Diginc Technology') ?></strong><br>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-6 valtitle"><?php echo  display('ref_number') ?>: .........</div>
                            <div class="col-sm-6 payslipfooterbandk"><?php echo  display('name_of_bank') ?>: <?php echo (!empty($paymentdata[0]['bank_name']) ? $paymentdata[0]['bank_name'] : '..........') ?></div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
